...
description: >-
  Run commands to start Grafana local dev after initial setup. Use when the user
  asks how to start the dev server, run Grafana locally, frontend/backend watchers,
  hot reload, live reload, or development with hot reloading.
---
